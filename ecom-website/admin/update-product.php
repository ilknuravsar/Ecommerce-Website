    ...
    <div class="wrapper">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {
                            ?>
                                <img src="<?php echo SITEURL; ?>images/product/<?php echo $current_image;  ?>" width="150px">                            <?php
                        }
                ...
                <tr>
                    ...
                    <td>
                        <select name="category">
                            ...
                            ?>
                            <option value="0">TestCategory</option>
                        </select>
                    </td>
                </tr>
                <tr>
        ...
        if(isset($_POST['submit']))
        {
            ...
            else
            {
                ...
                {
                    $_SESSION['update'] = "<div class='error'>Product Updated Successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-product.php');
                }
